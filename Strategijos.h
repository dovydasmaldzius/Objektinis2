...
[](const Studentas& s){ return s.rezultatas >= 5; });

auto it = std::remove_if(studentai.begin(), studentai.end(), [](const Studentas& s){ return s.rezultatas < 5; });
...
studentai.begin(), studentai.end(), [](const Studentas& s) {
