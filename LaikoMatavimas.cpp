...
grupe.clear();
    ...
    cout << n << " irasu dalijimo i dvi grupes laikas, panaikinant pradini Vektoriu: " << std::chrono::duration<double>(end-start).count() << endl;
...
for(const auto& s : vargsiukai)
    ...
    cout << n << " irasu nelaimingu irasymo i faila laikas: " << std::chrono::duration<double>(end-start).count() << endl;
start = std::chrono::high_resolution_clock::now();
...
auto total_end = std::chrono::high_resolution_clock::now();
    cout << n << " irasu testo laikas: " << std::chrono::duration<double>(total_end-total_start).count() << endl;
}
}